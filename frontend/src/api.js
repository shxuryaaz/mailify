...
export const api = {
  ...
  editProfile: (bucket, profileText) => request("/profiles/edit", { method: "POST", body: { bucket, profileText } }),
  rollbackProfile: (bucket, version) => request("/profiles/rollback", { method: "POST", body: { bucket, version } }),
